    ...
    , mIsEligibleOutdoorTemperature(false)
{
    ...
    connect(mSchemeDataProvider.get(), &SchemeDataProvider::effectiveTemperatureChanged, this, [&](){
        emit setTemperatureChanged(mSchemeDataProvider->effectiveTempratureMonitoring());
    });
