...
extern const uint32_t RunningMode_internal_data_[];
enum SystemType : int;
bool SystemType_IsValid(int value);
extern const uint32_t SystemType_internal_data_[];
class LiveDataPoint;
...
template <>
internal::EnumTraitsT<::RunningMode_internal_data_>
    internal::EnumTraitsImpl::value<::RunningMode>;
template <>
internal::EnumTraitsT<::SystemType_internal_data_>
    internal::EnumTraitsImpl::value<::SystemType>;
}  // namespace protobuf
}  // namespace google
...
enum SystemType : int {
  ...
  SystemType_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  SystemType_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool SystemType_IsValid(int value);
extern const uint32_t SystemType_internal_data_[];
inline constexpr SystemType SystemType_MIN =
    static_cast<SystemType>(0);
inline constexpr SystemType SystemType_MAX =
    static_cast<SystemType>(5);
inline constexpr int SystemType_ARRAYSIZE = 5 + 1;
const ::google::protobuf::EnumDescriptor*
SystemType_descriptor();
template <typename T>
const std::string& SystemType_Name(T value) {
  static_assert(std::is_same<T, SystemType>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to SystemType_Name().");
  return SystemType_Name(static_cast<SystemType>(value));
}
template <>
inline const std::string& SystemType_Name(SystemType value) {
  return ::google::protobuf::internal::NameOfDenseEnum<SystemType_descriptor,
                                                 0, 5>(
      static_cast<int>(value));
}
inline bool SystemType_Parse(absl::string_view name, SystemType* value) {
...
enum RunningMode : int {
  ...
  RunningMode_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  RunningMode_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool RunningMode_IsValid(int value);
extern const uint32_t RunningMode_internal_data_[];
inline constexpr RunningMode RunningMode_MIN =
    static_cast<RunningMode>(0);
inline constexpr RunningMode RunningMode_MAX =
    static_cast<RunningMode>(6);
inline constexpr int RunningMode_ARRAYSIZE = 6 + 1;
const ::google::protobuf::EnumDescriptor*
RunningMode_descriptor();
template <typename T>
const std::string& RunningMode_Name(T value) {
  static_assert(std::is_same<T, RunningMode>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to RunningMode_Name().");
  return RunningMode_Name(static_cast<RunningMode>(value));
}
template <>
inline const std::string& RunningMode_Name(RunningMode value) {
  return ::google::protobuf::internal::NameOfDenseEnum<RunningMode_descriptor,
                                                 0, 6>(
      static_cast<int>(value));
}
inline bool RunningMode_Parse(absl::string_view name, RunningMode* value) {
  return ::google::protobuf::internal::ParseNamedEnum<RunningMode>(
...
/* @@protoc_insertion_point(class_definition:LiveDataPoint) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kSystemTypeFieldNumber = 14,
    kIsSyncFieldNumber = 13,
    kOnlineStatusFieldNumber = 16,
    kRunningModeFieldNumber = 15,
    kAutoLowFieldNumber = 17,
    kAutoHighFieldNumber = 18,
  };
  ...
  void set_system_type(::SystemType value);

  private:
  ::SystemType _internal_system_type() const;
  void _internal_set_system_type(::SystemType value);
  ...
  void set_running_mode(::RunningMode value);

  private:
  ::RunningMode _internal_running_mode() const;
  void _internal_set_running_mode(::RunningMode value);

  public:
  // optional float auto_low = 17;
  bool has_auto_low() const;
  void clear_auto_low() ;
  float auto_low() const;
  void set_auto_low(float value);

  private:
  float _internal_auto_low() const;
  void _internal_set_auto_low(float value);

  public:
  // optional float auto_high = 18;
  bool has_auto_high() const;
  void clear_auto_high() ;
  float auto_high() const;
  void set_auto_high(float value);

  private:
  float _internal_auto_high() const;
  void _internal_set_auto_high(float value);
...
inline ::SystemType LiveDataPoint::system_type() const {
  // @@protoc_insertion_point(field_get:LiveDataPoint.system_type)
  return _internal_system_type();
}
inline void LiveDataPoint::set_system_type(::SystemType value) {
  _internal_set_system_type(value);
  _impl_._has_bits_[0] |= 0x00001000u;
  // @@protoc_insertion_point(field_set:LiveDataPoint.system_type)
}
inline ::SystemType LiveDataPoint::_internal_system_type() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::SystemType>(_impl_.system_type_);
}
inline void LiveDataPoint::_internal_set_system_type(::SystemType value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void LiveDataPoint::clear_running_mode() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.running_mode_ = 0;
  _impl_._has_bits_[0] &= ~0x00008000u;
}
inline ::RunningMode LiveDataPoint::running_mode() const {
  // @@protoc_insertion_point(field_get:LiveDataPoint.running_mode)
  return _internal_running_mode();
}
inline void LiveDataPoint::set_running_mode(::RunningMode value) {
  _internal_set_running_mode(value);
  _impl_._has_bits_[0] |= 0x00008000u;
  // @@protoc_insertion_point(field_set:LiveDataPoint.running_mode)
}
inline ::RunningMode LiveDataPoint::_internal_running_mode() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::RunningMode>(_impl_.running_mode_);
}
inline void LiveDataPoint::_internal_set_running_mode(::RunningMode value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.running_mode_ = value;
}
...
// optional float auto_low = 17;
inline bool LiveDataPoint::has_auto_low() const {
  bool value = (_impl_._has_bits_[0] & 0x00010000u) != 0;
  return value;
}
inline void LiveDataPoint::clear_auto_low() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.auto_low_ = 0;
  _impl_._has_bits_[0] &= ~0x00010000u;
}
inline float LiveDataPoint::auto_low() const {
  // @@protoc_insertion_point(field_get:LiveDataPoint.auto_low)
  return _internal_auto_low();
}
inline void LiveDataPoint::set_auto_low(float value) {
  _internal_set_auto_low(value);
  _impl_._has_bits_[0] |= 0x00010000u;
  // @@protoc_insertion_point(field_set:LiveDataPoint.auto_low)
}
inline float LiveDataPoint::_internal_auto_low() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.auto_low_;
}
inline void LiveDataPoint::_internal_set_auto_low(float value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.auto_low_ = value;
}

// optional float auto_high = 18;
inline bool LiveDataPoint::has_auto_high() const {
  bool value = (_impl_._has_bits_[0] & 0x00020000u) != 0;
  return value;
}
inline void LiveDataPoint::clear_auto_high() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.auto_high_ = 0;
  _impl_._has_bits_[0] &= ~0x00020000u;
}
inline float LiveDataPoint::auto_high() const {
  // @@protoc_insertion_point(field_get:LiveDataPoint.auto_high)
  return _internal_auto_high();
}
inline void LiveDataPoint::set_auto_high(float value) {
  _internal_set_auto_high(value);
  _impl_._has_bits_[0] |= 0x00020000u;
  // @@protoc_insertion_point(field_set:LiveDataPoint.auto_high)
}
inline float LiveDataPoint::_internal_auto_high() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.auto_high_;
}
inline void LiveDataPoint::_internal_set_auto_high(float value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.auto_high_ = value;
}
...
template <>
struct is_proto_enum<::SystemType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::SystemType>() {
  return ::SystemType_descriptor();
}
template <>
struct is_proto_enum<::RunningMode> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::RunningMode>() {
  return ::RunningMode_descriptor();
}
